...
\newcommand{\resumeArxivheading}[3]{
  \vspace{-2pt} \item\small{
    {\textbf{#1} \vspace{-2pt}}\\
    {\textit{\small#2}}\\
    \underline{\small#3}
...
\begin{center}
    ...
    \small
    \faAt \hspace{.5pt} \href{mailto:fl453@cornell.edu}{fl453@cornell.edu}
    $|$
...
\section{Publications}
  ...
  \resumeSubHeadingListStart
    ...
    \resumePubheading{ShapKO: Shapley-Adaptive Modality Knockout for Robust Multimodal Learning}{Nusrat Binta Nizam, \textbf{Fengbei Liu}, Sunwoo Kwak, Minh Nguyen, Ruining Deng, Mert R. Sabuncu}{MICCAI 2026}
    \resumePubheading{An Artificial Intelligence Model to Detect Abnormal Ejection Fraction from Non-Contrast Chest Computed Tomography: The CT-LVEF study}{Jayant Raikhelkar, Zilong Bai, Ashley N Beecy, Ilan Richter, \textbf{Fengbei Liu}, et al.}{European Heart Journal-Digital Health 2026}
    \resumePubheading{Cardio Amyloid-AI: Advanced Multimodal Screening for Transthyretin Cardiac Amyloidosis in Severe Aortic Stenosis Patients}{Nusrat Binta Nizam, Ashley N Beecy, Jacob W Groenendyk, \textbf{Fengbei Liu}, et al.}{European Heart Journal-Digital Health 2026}
    ...
    \resumePubheading{Automatic Segmentation of Multiple Structures in Knee Arthroscopy Using Deep Learning}{Yaqub Jonmohamadi, Yu Takeda, \textbf{Fengbei Liu}, Fumio Sasazawa, Gabriel Maicas, Ross Crawford, Jonathan Roberts, Ajay K. Pandey, Gustavo Carneiro}{IEEE Access 2020}
  ...
  \resumeSubHeadingListStart
    \resumeArxivheading{MAdam: Metric-Aware Multi-Objective Adam}{\textbf{Fengbei Liu}, Rachit Saluja, Sunwoo Kwak, Ruibo Wang, Ruining Deng, Heejong Kim, Johannes C. Paetzold, Mert R. Sabuncu}{arXiv:2606.03904, 2026}
    \resumeArxivheading{Agentic Large-Language-Model Systems in Medicine: A Systematic Review and Taxonomy}{Abdul Mohaimen Al Radi, Xu Cao, Fanyang Yu, Yuyuan Liu, \textbf{Fengbei Liu}, Chong Wang, Yuanhong Chen, Jintai Chen, Hu Wang, Yanda Meng, Zhenyi Wang, Chen Chen, Mubarak Shah, Tianyu Han, Christos Davatzikos, MacLean P. Nasrallah, Yu Tian}{TechRxiv, 2025}
    \resumeArxivheading{Asymmetric Co-teaching with Multi-view Consensus for Noisy Label Learning}{\textbf{Fengbei Liu}, Yuanhong Chen, Chong Wang, Yu Tian, Gustavo Carneiro}{arXiv:2301.01143, 2023}
...
\section{Professional Activities}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Reviewer: }{ICCV 2021/2023, MICCAI 2021/2026, CVPR 2022/2023/2024/2026, ECCV 2022/2024, BMVC 2022, NeurIPS 2023/2024/2026, ICLR 2024, ICML 2024} \\ \vspace{3pt}
